...
workbenchActionsRegistry.registerWorkbenchAction(new SyncActionDescriptor(OpenTaskManager, OpenTaskManager.ID, OpenTaskManager.LABEL), 'Open Task Manager');
